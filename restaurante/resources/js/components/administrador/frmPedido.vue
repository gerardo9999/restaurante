                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarPedido(1,buscar,criterio)" id="texto" name="texto" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarPedido(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                       ...
                                       <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control col-md-3" v-model="criterio">
                                                <option value="cliente">Ubicacion</option>
                                                </select>
                                                <input type="text" v-model="buscar" @keyup.enter="listarPedido(1,buscar,criterio)" id="texto" name="texto" class="form-control" placeholder="Texto a buscar">
                                                <button type="submit" @click="listarPedido(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                            </div>
                                                    <div class="input-group">
                                                        <select class="form-control col-md-3" v-model="criterio">
                                                        <option value="cliente">Reserva</option>
                                                        </select>
                                                        <input type="text" v-model="buscar" @keyup.enter="listarPedido(1,buscar,criterio)" id="texto" name="texto" class="form-control" placeholder="Texto a buscar">
                                                        <button type="submit" @click="listarPedido(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idRepartidor">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="repartidor in arrayRepartidor" :key="repartidor.id" :value="repartidor.id" v-text="repartidor.nombreCompleto"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idUbicacion">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="ubicacion in arrayUbicacion" :key="ubicacion.id" :value="ubicacion.id" v-text="ubicacion.nombreCompleto"></option>
                                        </select>                                        
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Reserva</label>
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idReserva">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="reserva in arrayReserva" :key="reserva.id" :value="reserva.id" v-text="reserva.nombreCompleto"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Fecha Entrega</label>
                                    <div class="col-md-9">
                                        <input type="date" v-model="fechaEntrega" class="form-control" placeholder="Fecha Entrega">                                        
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Hora Entrega</label>
                                    <div class="col-md-9">
                                        <input type="time" v-model="horaEntrega" class="form-control" placeholder="hora de Entrega">                                        
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Glosa</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="glosa" class="form-control" placeholder="Glosa">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Monto Total</label>
                                    <div class="col-md-9">
                                        <input type="float" v-model="montoTotal" class="form-control" placeholder="Monto Total">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input"> Repartidor</label>
                                    <div class="col-md-9">
                                        <input type="tesxt" v-model="repartidor" class="form-control" placeholder="Repartidor">
                                    </div>
                                </div>
                                 <div class="form-group row">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="guardarPedido()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarPedido()">Modificar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods : {
            ...
            guardarPedido(){
                ...
                let me = this;
                let url  = '/pedido/guardar';
                let header = { headers : {'Content-Type' : 'multipart/form-data'} }
                let data = new FormData();
                    data.append('idCliente', this.idCliente)
                    data.append('fecha'     , this.fecha)
                    data.append('fechaEntrega'       , this.fechaEntrega)
                    data.append('horaEntrega'     , this.horaEntrega)
                    data.append('glosa'     , this.glosa)
                    data.append('montoTotal'     , this.montoTotal)
                ...
                axios.post(url,data,header).then(function (response) {
                    ...
                    iziToast.success({
                            title: 'Exito!',
                            message: 'Se ha registrado una nuevo pedido',
                    });
                }).catch(function (error) {
                    console.log(error);
                });
            ...
            actualizarPedido(){
               if (this.validarPedido()){
                ...
                axios.post(url,{
                    'comensales': this.fecha,
                    'telefono'  : this.fechaEntrega,
                    'fecha'     : this.fecha,
                    'hora'      : this.hora,
