  ...
  <body>
    <div class="page-holder">
      ...
      <header class="header">
        <nav class="navbar navbar-expand-lg fixed-top">
          <div class="container"><a href="#" class="navbar-brand"> <img src="{{ asset('distribution/img/logo.png')}}" alt="Italiano" width="100"></a>
      ...
      <div id="slider" class="sl-slider-wrapper">
        <div class="sl-slider">
          ...
          <div data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2" class="sl-slide bg-1">
            <div style="background-image: url(distribution/img/hero-bg.jpg);" class="sl-slide-inner">
              <div class="container">
          ...
          <div data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5" class="sl-slide bg-2">
            <div style="background-image: url(distribution/img/hero-bg02.jpg);" class="sl-slide-inner">
              <div class="container">
          ...
          <div data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1" class="sl-slide bg-3">
            <div style="background-image: url(distribution/img/hero-bg03.jpg);" class="sl-slide-inner">
              <div class="container">
    ...
    <section id="services" class="services">
      <div class="container text-center">
        ...
        <div class="row">
          ...
          <div class="col-md-4 service mb-4 mb-lg-0">
            <div class="icon"><i class="icon-hat"></i></div>
            <div class="text">
          ...
          <div class="col-md-4 service mb-4 mb-lg-0">
            <div class="icon"><i class="icon-plate"></i></div>
            <div class="text">
    ...
    <section id="app" class="app">
      <div class="container text-center has-border">
        <h5 class="h4">Our app is availble now, we made it easire, Download it now.</h5>
        <ul class="list-inline">
          <li class="list-inline-item"><a href="https://bootstraptemple.com/" target="_blank" title="Google Play" class="btn-unique-white">Google Play</a></li>
          <li class="list-inline-item"><a href="https://bootstraptemple.com/" target="_blank" title="Appstore" class="btn-unique-white">App Store</a></li>
          <li class="list-inline-item"><a href="https://bootstraptemple.com/" target="_blank" title="Bootstrap Temple" class="btn-unique-white">Download this template</a></li>
        </ul>
      </div>
    </section>
    <!-- End App Section-->
    ...
    <section id="dishes" class="dishes">
      <div class="container text-center">
        ...
        <div class="owl-carousel owl-theme">
          <!-- item-->
          <div class="dish">
            <div class="profile"><img src="{{ asset('distribution/img/dish-c.png')}}" alt="Fried Shrimp" class="img-fluid d-block mx-auto">
          ...
          <!-- item-->
          <div class="dish">
            <div class="profile"><img src="{{ asset('distribution/img/dish-b.png')}}" alt="Fried Shrimp" class="img-fluid d-block mx-auto">
              <div class="price"><span>$17</span></div>
            </div>
            <div class="text">
              <h4>Fried Shrimp</h4>
          ...
          <!-- item-->
          <div class="dish">
            <div class="profile"><img src="{{ asset('distribution/img/dish-a.png')}}" alt="Fried Shrimp" class="img-fluid d-block mx-auto">
              <div class="price"><span>$17</span></div>
            </div>
            <div class="text">
              <h4>Fried Shrimp</h4>
        ...
        <div class="row">
          <div class="col-md-4 mb-5 mb-lg-0">
            <div class="item">
              ...
              <div class="profile"><img src="{{ asset('distribution/img/dish-d.png')}}" alt="Dish Name" class="img-responsive"></div>
              <div class="text">
                <h4>Dish Name </h4>
      ...
      <div class="container">
        ...
        <div class="menu">
          ...
          <ul role="tablist" class="nav nav-tabs text-center has-border d-flex justify-content-center">
            <li role="presentation" class="nav-item"><a href="#breakfast" aria-controls="breakfast" role="tab" data-toggle="tab" class="nav-link active">Breakfast</a></li>
            <li role="presentation" class="nav-item"><a href="#lunch" aria-controls="lunch" role="tab" data-toggle="tab" class="nav-link">Lunch</a></li>
            <li role="presentation" class="nav-item"><a href="#dinner" aria-controls="dinner" role="tab" data-toggle="tab" class="nav-link">Dinner</a></li>
            <li role="presentation" class="nav-item"><a href="#party" aria-controls="party" role="tab" data-toggle="tab" class="nav-link">Party</a></li>
            <li role="presentation" class="nav-item"><a href="#drinks" aria-controls="drinks" role="tab" data-toggle="tab" class="nav-link">Drinks</a></li>
          </ul>
          <!-- Tab panes-->
          <div class="tab-content">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="menu-item has-border clearfix recommended">
                    ...
                    <div class="item-price pull-right"><strong class="text-large text-primary">20$</strong><span class="text-medium">Recommended </span>
                    </div>
                  </div>
                </div>
                <!-- item-->
                ...
                <div class="col-lg-6">
                  <div class="menu-item has-border clearfix">
                    ...
                    <div class="item-price pull-right"><strong class="text-large text-primary">20$</strong>
                    </div>
                  </div>
                </div>
                <!-- item-->
            ...
            <!-- End Dinner Panel-->
            <!-- Party Panel-->
            <div id="party" role="tabpanel" class="tab-pane fade">
              <div class="row">
                <!-- item-->
                <div class="col-lg-6">
                  <div class="menu-item has-border clearfix recommended">
            ...
            <!-- End Party Panel-->
            <!-- Drinks Panel-->
            <div id="drinks" role="tabpanel" class="tab-pane fade">
              <div class="row">
                <!-- item-->
                <div class="col-lg-6">
                  <div class="menu-item has-border clearfix">
          ...
          <div class="col-lg-6">
            <div class="details-outer d-flex align-items-center">
              <div class="details">
                ...
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat..</p><a href="#" class="read-more btn-unique">Read More</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="gellery">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg01-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg01.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg02-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg02.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg03-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg03.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg04-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg04.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg05-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg05.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg06-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg06.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg04-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg04.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            ...
            <!-- Item-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
              <div class="item"><img src="{{ asset('distribution/img/bg07-small.jpg')}}" alt="image"><a href="{{ asset('distribution/img/bg07.jpg')}}" data-lightbox="image-1" data-title="Image Caption" class="has-border"><span class="icon-search"></span></a></div>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="col-lg-10 mx-auto">
                  <div class="row">
                    ...
                    <label for="date" class="col-md-6 unique">Date
                      <input id="date" name="date" type="text" data-language="en" required="" class="datepicker-here">
                    </label>
                    <label for="time" class="col-md-6 unique">Time
                      <input id="time" name="time" type="text" required="" class="timepicker">
                    </label>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 brief">
            <div class="header"><img src="{{ asset('distribution/img/logo-footer.png')}}" alt="italiano" width="100"></div>
      ...
      <div class="copyrights">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-7">
              <p class="mb-0">© 2017 Italiano Restaurant. Template By <a href="https://bootstraptemple.com/" target="_blank">BootstrapTemple.com</a></p>
    ...
    <div id="style-switch" class="collapse">
      ...
      <p><img src="{{ asset('distribution/img/template-mac.png')}}" alt="" class="img-fluid"></p>
