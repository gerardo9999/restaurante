...
<div class="container-fluid">
    <div class="card card-accent-info">
        ...
        <form action="{{ route('precio.update',['id'=>$precio[0]->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="card-body">
            <div class="row">
                <div class="form-group col-6">
                    <label for="precio" class="label-items">Precio</label>
                    <input type="text" name="precio" class="form-control form-control-sm" value="{{ old('precio') }}" placeholder="escribe los precio" >
                    @error('precio') 
